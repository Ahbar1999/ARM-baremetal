...
extern uint32_t* STK_CSR = (uint32_t*)STK_CSR_ADDR;
extern uint32_t* STK_RVR = (uint32_t*)STK_RVR_ADDR; 
extern uint32_t* STK_CVR = (uint32_t*)STK_CVR_ADDR;
extern uint32_t* STK_CALIB = (uint32_t*)STK_CALIB_ADDR;
